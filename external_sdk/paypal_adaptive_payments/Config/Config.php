...
if (gcr::paypalSandbox)
{
    ...
    $paypal_endpoint = 'https://svcs.sandbox.paypal.com/';
...
else
{
    ...
    $paypal_endpoint = 'https://svcs.paypal.com/';
    $paypal_redirect_url = 'https://www.paypal.com/webscr&cmd=';
    $paypal_app_id = 'APP-5CM79169L73766912';
}
define('API_USERNAME', $paypal_username);
...
define('API_PASSWORD', $paypal_password);

/**
# API_Signature:The Signature associated with the API user. which is generated by paypal.
*/

define('API_SIGNATURE', $paypal_signature);

/**
# Endpoint: this is the server URL which you have to connect for submitting your API request.
*/

define('API_ENDPOINT', $paypal_endpoint);
...
define('APPLICATION_ID', $paypal_app_id);
define('DEVICE_ID','globalclassroom');
define('PAYPAL_REDIRECT_URL', $paypal_redirect_url);
define('DEVELOPER_PORTAL', 'https://developer.paypal.com');
define('LOGFILENAME', gcr::rootDir . 'debug/paypal.log');
define('DEVICE_IPADDRESS', '74.205.116.33');
